    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                 [
                    'text' => 'Aseguradora',
                    'route'  => 'borrarLineas.index',
                    'icon' => 'fas fa-air-freshener',
                ], 
                [
                    'text' => 'Ventas',
                    'route'  => 'borrarVentas.index',
                    'icon' => 'fas fa-air-freshener',
                ],
            ]
        ], 
        [
            'text'        => 'REPORTE GESTIÓN',
            'icon'        => 'far fa-fw fa-file',
            'label_color' => 'success',
            'submenu' => [
                 [
                    'text' => 'PÓLIZAS',
                    'route'  => 'reporteGestionPoliza.index',
                    'icon' => 'far fa-fw fa-file',
                ], 
                [
                    'text' => 'GENERAL',
                    'route'  => 'reporteGestionGral.index',
                    'icon' => 'far fa-fw fa-file',
                ],
            ]
        ],
        ...
        'Datatables' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdn.datatables.net/plug-ins/9dcbecd42ad/i18n/Spanish.json',
                ],
                [
                    'type' => 'css',
                    'asset' => false,
